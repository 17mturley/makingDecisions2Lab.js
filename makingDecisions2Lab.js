...
switch  (letterGrade){
  case "A":
    response = "The student is doing excellently.";
    break;
  case "B":
    response = "The student is doing well.";
    break;
  case "C":
    response = "The student is doing alright.";
    break;
  case "D":
    response = "The student is not doing very well.";
    break;
  case "F":
    response = "The student is failing."
  default:
    response = "Not an eligible grade."
